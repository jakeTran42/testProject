...
//            let ref = Database.database().reference(fromURL: "https://testproject-afc1e.firebaseio.com/")
    ...
    func handleLoginRegisterChange() {
        let segTitle = loginRegisterSegmentedControl.titleForSegment(at: loginRegisterSegmentedControl.selectedSegmentIndex)
        loginRegisterButton.setTitle(segTitle, for: .normal)
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(r: 60, g: 60, b: 165)
